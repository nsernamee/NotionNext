...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'nsernamee', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的大学生 :)', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://github.com/nsernamee', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, nsernamee', // 网站关键词 英文逗号隔开
